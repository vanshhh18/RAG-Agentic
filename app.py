...
# from retrieval import hybrid_search  # your RAG function
...
# st.title("⚡ Agentic AI: RAG vs Generic LLM")
...
#     with col1:
#         st.subheader("🔍 RAG LLM (Your Data)")
...
#     with col2:
#         st.subheader("🤖 Generic LLM")
#         st.write(generic_response)


#     # =========================
#     # 4. AGENTIC COMPARISON SCORE
#     # =========================
#     st.markdown("---")
...
.hero-title span {
    background: linear-gradient(90deg, #5B63F5, #A78BFA);
...
div[data-testid="stTextInput"] > div > div > input:focus {
    border-color: #5B63F5 !important;
    box-shadow: 0 0 0 3px rgba(91,99,245,0.15) !important;
}

/* ── Run button ── */
div[data-testid="stButton"] > button {
    background: linear-gradient(135deg, #5B63F5, #7C3AED) !important;
    color: #fff !important;
...
.badge-rag {
    ...
    color: #818CF8;
    border: 1px solid rgba(91,99,245,0.3);
}
.badge-llm {
...
/* ── Agent insight card ── */
.insight-card {
    background: linear-gradient(135deg, #0F1120 0%, #131626 100%);
...
/* ── Spinner ── */
.stSpinner > div {
    border-top-color: #5B63F5 !important;
}
